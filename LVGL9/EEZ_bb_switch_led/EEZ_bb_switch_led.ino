...
//Ultrasonic pins and setups

const int ledPin27 = 27;  // CN1 Extended I/O
...
void setup() {
  ...
  //CN1 Extended IO PIN 3.3v(red) -> 27(yellow) -> 22(blue) -> GND(black)
  //P3 Extended IO PIN 21(red - also dims backlight) -> 22(wire yellow) -> 35(wire blue) -> GND(black)
  pinMode(ledPin27, OUTPUT);  // Sets the mode as an Output

  //Register event handler
  lv_obj_add_event_cb(objects.switch_led, switch_event_handler, LV_EVENT_VALUE_CHANGED, objects.label_switch_state);
}
