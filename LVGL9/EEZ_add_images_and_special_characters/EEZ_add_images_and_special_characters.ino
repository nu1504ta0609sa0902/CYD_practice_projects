...
int updateNeedleValueEvery = random(0, 2);
...
void mockCompassDirection() {
  ...
  if (directionChanged) {
    ...
    updateNeedleValueEvery = random(0, 10); 
  }
}
...
void loop() {
  ...
  if (value % updateNeedleValueEvery == 0) {

    lv_image_set_rotation(objects.image_needle, value * 10);
    lv_label_set_text_fmt(objects.label_value, "£ 
    %d", value);
